...
class StatusCRUDTest(TestCase):
    ...
    def test_status_create_view(self):
        ...
        self.assertRedirects(response, f'{self.login_url}?next={reverse("status_create")}')
    ...
    def test_status_update_view(self):
        ...
        self.assertRedirects(response, f'{self.login_url}?next={reverse("status_update", args=[self.status.id])}')
    ...
    def test_status_delete_view(self):
        ...
        self.assertRedirects(response, f'{self.login_url}?next={reverse("status_delete", args=[self.status.id])}')
